...
public class BreathiWelcomeScreen extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!prefManager.isFirstTimeLaunchbreathi()) {
            launchAirOwlid();
            finish();
        }
        ...
        setContentView(R.layout.activity_breathi_welcome_screen);
        ConnfigView();
    }
    ...
    private void ConnfigView() {
        ...
        layouts = new int[]{
                R.layout.tutorial_breathi_screen1,
                R.layout.tutorial_breathi_screen2,
                R.layout.tutorial_breathi_screen3,
                R.layout.tutorial_breathi_screen4,
        };
        setOnclickEvent();
    ...
    private void launchAirOwlid() {
        prefManager.setFirstTimeLaunchBreathi(false);
        Intent airOwlid = new Intent(getApplicationContext(), AddDeviceBreathi.class);
