...
public class LineCardOne extends CardController {
    ...
    public LineCardOne(RelativeLayout card , Context context, String[] labels, float[][] values, boolean isPublic){
        super(card);
        mContext = context;
...
//    public LineCardOne(RelativeLayout card, Context context) {
//        super(card);
//
//        mContext = context;
//        mChart = (LineChartView) card.findViewById(R.id.chart1);
