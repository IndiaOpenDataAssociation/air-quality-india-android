 ...
 */
public class AirOwlWi extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.activity_add_device_air_owl_wifi, container, false);
